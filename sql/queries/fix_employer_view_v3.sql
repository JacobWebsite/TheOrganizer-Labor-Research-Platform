...
-- FIXED VERSION - removed geocode_quality column
-- Run with: psql -U postgres -d olms_multiyear -f fix_employer_view_v3.sql
...
CREATE INDEX IF NOT EXISTS idx_employer_search_name ON f7_employers (LOWER(employer_name));
CREATE INDEX IF NOT EXISTS idx_employer_search_state ON f7_employers (state);
