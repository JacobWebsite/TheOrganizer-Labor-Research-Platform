*Auto-generated by `scripts/maintenance/generate_db_inventory.py` on 2026-02-22 21:33:38. Re-run to refresh.*
...
| Indexes | 290 |
| Total index size | 4027 MB |
| Estimated total rows across all tables | 33,952,826 |
| Empty tables | 2 |
| Last ANALYZE (manual) | 2026-02-21 15:34:32 |
| Last ANALYZE (auto) | 2026-02-22 18:02:14 |
...
| Table | Rows |
|-------|------|
| `master_employer_source_ids` | 3,071,209 |
| `ar_disbursements_emp_off` | 2,813,011 |
| `master_employers` | 2,732,195 |
| `osha_violations_detail` | 2,244,955 |
| `nlrb_docket` | 2,046,151 |
| `irs_bmf` | 2,043,379 |
| `qcew_annual` | 1,943,426 |
| `nlrb_participants` | 1,907,528 |
| `unified_match_log` | 1,737,107 |
...
| `master_employer_merge_log` | 289,111 |
