# Workforce Demographics Estimation: Complete Summary (V1-V3)

**Date:** 2026-03-09
**Scope:** 3 development iterations, 22 methods tested, 797 training + 398 holdout company evaluations
...
**Total improvement: 5.74 -> 4.33 = 24.6% reduction in race MAE.**

### 7.2 What We Learned at Each Stage
...
| M4c Top10-Occ | V3 | V3 | Identical to M4 |
| M4d State-Top5 | V3 | V3 | Identical to M4 |
| M5d Corr-Min-Adapt (flipped M5b) | V3 | V3 | Negligible improvement (+0.02 MAE) |

### 7.4 Surviving Production Candidates
...
| **M3 IPF** | Gender estimation only | 5.81 (race) | None | 71 race wins in specific segments; best gender method |

---

## 8. Performance by Employer Type

### 8.1 By Industry (V3 Holdout, Best Method)
...
### 8.2 By Key Dimensions (V3 Holdout)
...
### 9.2 The High-Minority Problem (Unsolved)
...
### 9.3 Industry-Specific Structural Biases
...
### 9.4 The Asian Underestimation Problem
...
### 10.1 Primary Strategy: Context-Dependent Method Selection

| Context | Method | Expected MAE |
|---------|--------|-------------|
| **Default (all employers)** | M3c Var-Damp-IPF | ~4.3 |
| **High-minority employers (>50%)** | M1b Learned-Wt | ~10.4 |
| **Finance/Insurance, Utilities (small suburban)** | M3 IPF (raw) | ~1.3-1.7 |
...
### 10.2 If Only One Method

Use **M3c Var-Damp-IPF**. Best overall holdout MAE (4.33), good generalization (+0.23 delta), per-industry customization via dampening alpha. Formula:
...
### 10.3 If Maximum Robustness Required
...
| `docs/DEMOGRAPHICS_ESTIMATION_SUMMARY.md` | This document (V1-V3 complete summary) |
