        ...
        for row in reader:
            try:
                ...
                """, (
                    ...
                    row.get('FIRST_NAME', '')[:100] if row.get('FIRST_NAME') else '',
                    row.get('MIDDLE_NAME', '')[:100] if row.get('MIDDLE_NAME') else '',
                    row.get('LAST_NAME', '')[:100] if row.get('LAST_NAME') else '',
                    row.get('TITLE', '')[:255] if row.get('TITLE') else '',
        ...
        for row in reader:
            try:
                ...
                """, (
                    ...
                    row.get('CATEGORY', '')[:255] if row.get('CATEGORY') else '',
        ...
        for row in reader:
            try:
                ...
                """, (
                    ...
                    row.get('NAME', '')[:255] if row.get('NAME') else '',
