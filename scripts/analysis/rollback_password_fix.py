"""
Rollback helper for password-fix backups.
"""
...
BACKUP_ROOT = ROOT / "docs" / "password_fix_backups"


def main() -> int:
    parser = argparse.ArgumentParser(description="Rollback password-fix backups")
    parser.add_argument("--prefix", default="", help="Restore only paths under this prefix")
