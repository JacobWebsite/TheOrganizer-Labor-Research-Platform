"""
More fixes for remaining UNKNOWN
"""
import psycopg2
...
print("=" * 80)
print("More UNKNOWN Fixes")
print("=" * 80)

# Drop and recreate with more fixes
...
SELECT 
    ...
    CASE 
        ...
        WHEN employer_name ILIKE '%GE %' OR employer_name = 'GE' THEN 'IUE-CWA'
...
""")
print("  [OK] Created with more fixes")
...
# Top remaining UNKNOWN
print("\n--- Top 20 Still UNKNOWN ---")
cur.execute("""
...
for r in cur.fetchall():
    print(f"  {(r[0] or 'Unknown')[:50]:<50} {r[1] or 0:>8,.0f}")
