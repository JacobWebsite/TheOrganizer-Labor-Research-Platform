...
SYNTHETIC_TASKS: list[dict] = [
    ...
    {"id": "REG-2", "tier": "T0-R7", "section": "R7 Regressions",
     ...
     "description": "Both scheduled tasks errored 2026-04-25. Needs admin re-register.",
     "status": "open", "effort": "1h", "source": "R7 audit"},
    ...
    {"id": "REG-4", "tier": "T0-R7", "section": "R7 Regressions",
     ...
     "description": "R6 baseline 64.7% -> 67.4% (47,877 of 146,863). -7.6% matches.",
     "status": "open", "effort": "overnight", "source": "R7 audit"},
    ...
    {"id": "REG-6", "tier": "T0-R7", "section": "R7 Regressions",
     ...
     "description": "Scraper exists but no DB pipeline despite session claims.",
     "status": "open", "effort": "1-2d", "source": "R7 audit"},
